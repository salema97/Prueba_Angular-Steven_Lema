...
if (typeof window.__smartNav == 'undefined' || window.__smartNav == null) {
  ...
  window.__smartNav.update = function () {
    ...
    if (
      (index != -1 && index == fdurl.length - snSrc.length) ||
      fdurl == 'about:blank'
    )
      return;
  ...
  window.__smartNav.loadNewContent = function () {
    ...
    for (i = 0; i < kids.length; i++) {
      ...
      switch (tn) {
        case 'TITLE':
          if (tt == kids[i].outerHTML) continue;
          k.innerText = kids[i].text;
          hdm.insertAdjacentElement('afterbegin', k);
          continue;
        case 'BASEFONT':
          if (kids[i].innerHTML.length > 0) continue;
          break;
        default:
      ...
      if (typeof k != 'undefined' && k != null) hdm.appendChild(k);
    }
    ...
    else document.body.onload = sn._savedOnLoad;
    ...
    if (typeof sn.hif != 'undefined' && sn.hif != null) {
      ...
      if (sn.ie5) hif.parentElement.removeChild(hif);
  ...
  window.__smartNav.restoreFocus = function () {
    ...
    if (
      typeof sAeId == 'undefined' ||
      sAeId == null ||
      (typeof curAe != 'undefined' &&
        curAe != null &&
        (curAe.id == sAeId || curAe.name == sAeId))
    )
      return;
  ...
  window.__smartNav.saveHistory = function () {
    if (
      typeof window.__smartNav.hif != 'undefined' &&
      window.__smartNav.hif != null
    )
      window.__smartNav.hif.removeNode();
    if (
      typeof window.__smartNav.sHif != 'undefined' &&
      window.__smartNav.sHif != null &&
  ...
  window.__smartNav.stopHif = function () {
    ...
    var sn = window.__smartNav;
    if (
      (typeof sn.hifDoc == 'undefined' || sn.hifDoc == null) &&
      typeof sn.hif != 'undefined' &&
      sn.hif != null
    ) {
      try {
  ...
  window.__smartNav.init = function () {
    ...
    if (
      ...
      if (ae.length == 0) ae = document.activeElement.name;
      sn.ae = ae;
    } else sn.ae = null;
    try {
    ...
    if (
      typeof sn.hif.parentElement == 'undefined' ||
      sn.hif.parentElement == null
    )
  ...
  window.__smartNav.attachForm = function () {
    ...
    for (var i = 0; i < cf.length; i++) {
      if (
        typeof cf[i].__smartNavEnabled != 'undefined' &&
        cf[i].__smartNavEnabled != null
      ) {
        window.__smartNav.form = cf[i];
        window.__smartNav.form.insertAdjacentHTML(
          'beforeEnd',
          "<input type='hidden' name='__smartNavPostBack' value='false' />"
        );
        break;
      }
    }
    ...
    if (
      ...
      url.lastIndexOf(sfc) + sfc.length != url.length
    )
      return false;
